...
- This _really_ re-enforced my earlier lessons from the Sigur Ros gig - be at the front & only go see people you would happily site down and listen to for an hour at home.
- If you're enjoying it, stay until the lights come up; if you can, make sure you don't have a deadline to be somewhere afterwards.
