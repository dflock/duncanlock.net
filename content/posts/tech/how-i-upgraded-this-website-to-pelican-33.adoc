...
A special case for me is the {static}/posts/tech/better-figures-and-images-plugin-for-pelican.rst[Better Figures & Images plugin]. I use this plugin and I also wrote it - and it stopped working.
