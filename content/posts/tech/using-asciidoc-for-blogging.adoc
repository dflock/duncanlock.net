...
This will create a `source.adoc` file in the same folder. I tried to keep this as general purpose as possible, but there are _probably_ some things in here which are specific to my documents. There is a section at the top with some knobs to twiddle:
